...
# Calculating camera FOV and other constants
...
#        cv2.line(image2, (finalTarget[0] + xTrans, screenHeight), (finalTarget[0]  + xTrans, 0), (255, 0, 0), 2)
        ...
        cv2.line(blur, (corners[0][0][0],corners[0][0][1]), (corners[1][0][0],corners[1][0][1]), (0,255,0), 5)
        cv2.line(blur, (corners[1][0][0],corners[1][0][1]), (corners[2][0][0],corners[2][0][1]), (0,255,0), 5)
        cv2.line(blur, (corners[2][0][0],corners[2][0][1]), (corners[3][0][0],corners[3][0][1]), (0,255,0), 5)
        cv2.line(blur, (corners[3][0][0],corners[3][0][1]), (corners[0][0][0],corners[0][0][1]), (0,255,0), 5)
        ...
        # Put corners into network table to send to other raspberry pi
        sd.putNumber("transformedBoxP1x", corners[0][0][0])
        sd.putNumber("transformedBoxP1y", corners[0][0][1])

        sd.putNumber("transformedBoxP2x", corners[1][0][0])
        sd.putNumber("transformedBoxP2y", corners[1][0][1])

        sd.putNumber("transformedBoxP3x", corners[2][0][0])
        sd.putNumber("transformedBoxP3y", corners[2][0][1])

        sd.putNumber("transformedBoxP4x", corners[3][0][0])
        sd.putNumber("transformedBoxP4y", corners[3][0][1])
