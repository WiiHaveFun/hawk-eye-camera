...
#define __PYX_HAVE__MakeComposite
#define __PYX_HAVE_API__MakeComposite
/* Early includes */
#include "pythread.h"
#include <string.h>
#include <stdlib.h>
...
/* Module declarations from 'MakeComposite' */
...
static __Pyx_memviewslice __pyx_f_13MakeComposite_make_composite(__Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, int, int, int __pyx_skip_dispatch); /*proto*/
...
#define __Pyx_MODULE_NAME "MakeComposite"
extern int __pyx_module_is_main_MakeComposite;
int __pyx_module_is_main_MakeComposite = 0;

/* Implementation of 'MakeComposite' */
...
static const char __pyx_k_blank_image2[] = "blank_image2";
static const char __pyx_k_blank_image3[] = "blank_image3";
static const char __pyx_k_blank_image4[] = "blank_image4";
...
static PyObject *__pyx_n_s_blank_image2;
static PyObject *__pyx_n_s_blank_image3;
static PyObject *__pyx_n_s_blank_image4;
...
static PyObject *__pyx_pf_13MakeComposite_make_composite(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_blank_image, __Pyx_memviewslice __pyx_v_blank_image2, __Pyx_memviewslice __pyx_v_blank_image3, __Pyx_memviewslice __pyx_v_blank_image4, int __pyx_v_height, int __pyx_v_width); /* proto */
...
static PyObject *__pyx_pw_13MakeComposite_1make_composite(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static __Pyx_memviewslice __pyx_f_13MakeComposite_make_composite(__Pyx_memviewslice __pyx_v_blank_image, __Pyx_memviewslice __pyx_v_blank_image2, __Pyx_memviewslice __pyx_v_blank_image3, __Pyx_memviewslice __pyx_v_blank_image4, int __pyx_v_height, int __pyx_v_width, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_y;
  int __pyx_v_x;
  ...
  __Pyx_RefNannySetupContext("make_composite", 0);
 ...
 */
      ...
      __pyx_t_10 = -1;
      if (__pyx_t_7 < 0) {
        __pyx_t_7 += __pyx_v_blank_image2.shape[0];
        if (unlikely(__pyx_t_7 < 0)) __pyx_t_10 = 0;
      } else if (unlikely(__pyx_t_7 >= __pyx_v_blank_image2.shape[0])) __pyx_t_10 = 0;
      if (__pyx_t_8 < 0) {
        __pyx_t_8 += __pyx_v_blank_image2.shape[1];
        if (unlikely(__pyx_t_8 < 0)) __pyx_t_10 = 1;
      } else if (unlikely(__pyx_t_8 >= __pyx_v_blank_image2.shape[1])) __pyx_t_10 = 1;
      if (__pyx_t_9 < 0) {
        __pyx_t_9 += __pyx_v_blank_image2.shape[2];
        if (unlikely(__pyx_t_9 < 0)) __pyx_t_10 = 2;
      } else if (unlikely(__pyx_t_9 >= __pyx_v_blank_image2.shape[2])) __pyx_t_10 = 2;
      if (unlikely(__pyx_t_10 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_10);
        __PYX_ERR(0, 7, __pyx_L1_error)
      }
      __pyx_t_11 = (((*((unsigned char *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_blank_image2.data + __pyx_t_7 * __pyx_v_blank_image2.strides[0]) ) + __pyx_t_8 * __pyx_v_blank_image2.strides[1]) ) + __pyx_t_9 * __pyx_v_blank_image2.strides[2]) ))) == 0xFF) != 0);
      if (__pyx_t_11) {
 ...
 * 		for x in range(width):
 */
        __pyx_t_12.data = __pyx_v_blank_image2.data;
        __pyx_t_12.memview = __pyx_v_blank_image2.memview;
        __PYX_INC_MEMVIEW(&__pyx_t_12, 0);
        {
    Py_ssize_t __pyx_tmp_idx = __pyx_v_y;
        Py_ssize_t __pyx_tmp_shape = __pyx_v_blank_image2.shape[0];
    Py_ssize_t __pyx_tmp_stride = __pyx_v_blank_image2.strides[0];
        if (__pyx_tmp_idx < 0)
...

{
    Py_ssize_t __pyx_tmp_idx = __pyx_v_x;
        Py_ssize_t __pyx_tmp_shape = __pyx_v_blank_image2.shape[1];
    Py_ssize_t __pyx_tmp_stride = __pyx_v_blank_image2.strides[1];
        if (__pyx_tmp_idx < 0)
            __pyx_tmp_idx += __pyx_tmp_shape;
        if (!__Pyx_is_valid_index(__pyx_tmp_idx, __pyx_tmp_shape)) {
            PyErr_SetString(PyExc_IndexError,
...
__pyx_t_12.shape[0] = __pyx_v_blank_image2.shape[2];
__pyx_t_12.strides[0] = __pyx_v_blank_image2.strides[2];
    __pyx_t_12.suboffsets[0] = -1;

__pyx_t_13.data = __pyx_v_blank_image.data;
        __pyx_t_13.memview = __pyx_v_blank_image.memview;
        __PYX_INC_MEMVIEW(&__pyx_t_13, 0);
        {
    Py_ssize_t __pyx_tmp_idx = __pyx_v_y;
        Py_ssize_t __pyx_tmp_shape = __pyx_v_blank_image.shape[0];
    Py_ssize_t __pyx_tmp_stride = __pyx_v_blank_image.strides[0];
        if (__pyx_tmp_idx < 0)
            __pyx_tmp_idx += __pyx_tmp_shape;
        if (!__Pyx_is_valid_index(__pyx_tmp_idx, __pyx_tmp_shape)) {
            PyErr_SetString(PyExc_IndexError,
...
{
    Py_ssize_t __pyx_tmp_idx = __pyx_v_x;
        Py_ssize_t __pyx_tmp_shape = __pyx_v_blank_image.shape[1];
    Py_ssize_t __pyx_tmp_stride = __pyx_v_blank_image.strides[1];
        if (__pyx_tmp_idx < 0)
            __pyx_tmp_idx += __pyx_tmp_shape;
        if (!__Pyx_is_valid_index(__pyx_tmp_idx, __pyx_tmp_shape)) {
            PyErr_SetString(PyExc_IndexError,
...
__pyx_t_13.shape[0] = __pyx_v_blank_image.shape[2];
__pyx_t_13.strides[0] = __pyx_v_blank_image.strides[2];
    __pyx_t_13.suboffsets[0] = -1;

if (unlikely(__pyx_memoryview_copy_contents(__pyx_t_12, __pyx_t_13, 1, 1, 0) < 0)) __PYX_ERR(0, 8, __pyx_L1_error)
 ...
 */
      ...
      __pyx_t_10 = -1;
      if (__pyx_t_14 < 0) {
        __pyx_t_14 += __pyx_v_blank_image3.shape[0];
        if (unlikely(__pyx_t_14 < 0)) __pyx_t_10 = 0;
      } else if (unlikely(__pyx_t_14 >= __pyx_v_blank_image3.shape[0])) __pyx_t_10 = 0;
      if (__pyx_t_15 < 0) {
        __pyx_t_15 += __pyx_v_blank_image3.shape[1];
        if (unlikely(__pyx_t_15 < 0)) __pyx_t_10 = 1;
      } else if (unlikely(__pyx_t_15 >= __pyx_v_blank_image3.shape[1])) __pyx_t_10 = 1;
      if (__pyx_t_16 < 0) {
        __pyx_t_16 += __pyx_v_blank_image3.shape[2];
        if (unlikely(__pyx_t_16 < 0)) __pyx_t_10 = 2;
      } else if (unlikely(__pyx_t_16 >= __pyx_v_blank_image3.shape[2])) __pyx_t_10 = 2;
      if (unlikely(__pyx_t_10 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_10);
        __PYX_ERR(0, 11, __pyx_L1_error)
      }
      __pyx_t_11 = (((*((unsigned char *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_blank_image3.data + __pyx_t_14 * __pyx_v_blank_image3.strides[0]) ) + __pyx_t_15 * __pyx_v_blank_image3.strides[1]) ) + __pyx_t_16 * __pyx_v_blank_image3.strides[2]) ))) == 0xFF) != 0);
      if (__pyx_t_11) {

        /* "MakeComposite.pyx":12
 * 		for x in range(width):
 * 			if(blank_image3[y][x][3] == 255):
 * 				blank_image[y][x] = blank_image3[y][x]             # <<<<<<<<<<<<<<
 * 	for y in range(height):
 * 		for x in range(width):
 */
        __pyx_t_12.data = __pyx_v_blank_image3.data;
        __pyx_t_12.memview = __pyx_v_blank_image3.memview;
        __PYX_INC_MEMVIEW(&__pyx_t_12, 0);
        {
    Py_ssize_t __pyx_tmp_idx = __pyx_v_y;
        Py_ssize_t __pyx_tmp_shape = __pyx_v_blank_image3.shape[0];
    Py_ssize_t __pyx_tmp_stride = __pyx_v_blank_image3.strides[0];
        if (__pyx_tmp_idx < 0)
            __pyx_tmp_idx += __pyx_tmp_shape;
        if (!__Pyx_is_valid_index(__pyx_tmp_idx, __pyx_tmp_shape)) {
            PyErr_SetString(PyExc_IndexError,
...
{
    Py_ssize_t __pyx_tmp_idx = __pyx_v_x;
        Py_ssize_t __pyx_tmp_shape = __pyx_v_blank_image3.shape[1];
    Py_ssize_t __pyx_tmp_stride = __pyx_v_blank_image3.strides[1];
        if (__pyx_tmp_idx < 0)
            __pyx_tmp_idx += __pyx_tmp_shape;
        if (!__Pyx_is_valid_index(__pyx_tmp_idx, __pyx_tmp_shape)) {
            PyErr_SetString(PyExc_IndexError,
...
__pyx_t_12.shape[0] = __pyx_v_blank_image3.shape[2];
__pyx_t_12.strides[0] = __pyx_v_blank_image3.strides[2];
    __pyx_t_12.suboffsets[0] = -1;

__pyx_t_17.data = __pyx_v_blank_image.data;
        __pyx_t_17.memview = __pyx_v_blank_image.memview;
...
__pyx_t_17.shape[0] = __pyx_v_blank_image.shape[2];
__pyx_t_17.strides[0] = __pyx_v_blank_image.strides[2];
    __pyx_t_17.suboffsets[0] = -1;

if (unlikely(__pyx_memoryview_copy_contents(__pyx_t_12, __pyx_t_17, 1, 1, 0) < 0)) __PYX_ERR(0, 12, __pyx_L1_error)
 ...
 */
      ...
      __pyx_t_10 = -1;
      if (__pyx_t_18 < 0) {
        __pyx_t_18 += __pyx_v_blank_image4.shape[0];
        if (unlikely(__pyx_t_18 < 0)) __pyx_t_10 = 0;
      } else if (unlikely(__pyx_t_18 >= __pyx_v_blank_image4.shape[0])) __pyx_t_10 = 0;
      if (__pyx_t_19 < 0) {
        __pyx_t_19 += __pyx_v_blank_image4.shape[1];
        if (unlikely(__pyx_t_19 < 0)) __pyx_t_10 = 1;
      } else if (unlikely(__pyx_t_19 >= __pyx_v_blank_image4.shape[1])) __pyx_t_10 = 1;
      if (__pyx_t_20 < 0) {
        __pyx_t_20 += __pyx_v_blank_image4.shape[2];
        if (unlikely(__pyx_t_20 < 0)) __pyx_t_10 = 2;
      } else if (unlikely(__pyx_t_20 >= __pyx_v_blank_image4.shape[2])) __pyx_t_10 = 2;
      if (unlikely(__pyx_t_10 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_10);
        __PYX_ERR(0, 15, __pyx_L1_error)
      }
      __pyx_t_11 = (((*((unsigned char *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_blank_image4.data + __pyx_t_18 * __pyx_v_blank_image4.strides[0]) ) + __pyx_t_19 * __pyx_v_blank_image4.strides[1]) ) + __pyx_t_20 * __pyx_v_blank_image4.strides[2]) ))) == 0xFF) != 0);
      if (__pyx_t_11) {

        /* "MakeComposite.pyx":16
 * 		for x in range(width):
 * 			if(blank_image4[y][x][3] == 255):
 * 				blank_image[y][x] = blank_image4[y][x]             # <<<<<<<<<<<<<<
 * 	return blank_image
 */
        __pyx_t_12.data = __pyx_v_blank_image4.data;
        __pyx_t_12.memview = __pyx_v_blank_image4.memview;
        __PYX_INC_MEMVIEW(&__pyx_t_12, 0);
        {
    Py_ssize_t __pyx_tmp_idx = __pyx_v_y;
        Py_ssize_t __pyx_tmp_shape = __pyx_v_blank_image4.shape[0];
    Py_ssize_t __pyx_tmp_stride = __pyx_v_blank_image4.strides[0];
        if (__pyx_tmp_idx < 0)
            __pyx_tmp_idx += __pyx_tmp_shape;
        if (!__Pyx_is_valid_index(__pyx_tmp_idx, __pyx_tmp_shape)) {
            PyErr_SetString(PyExc_IndexError,
...
{
    Py_ssize_t __pyx_tmp_idx = __pyx_v_x;
        Py_ssize_t __pyx_tmp_shape = __pyx_v_blank_image4.shape[1];
    Py_ssize_t __pyx_tmp_stride = __pyx_v_blank_image4.strides[1];
        if (__pyx_tmp_idx < 0)
            __pyx_tmp_idx += __pyx_tmp_shape;
        if (!__Pyx_is_valid_index(__pyx_tmp_idx, __pyx_tmp_shape)) {
            PyErr_SetString(PyExc_IndexError,
...
__pyx_t_12.shape[0] = __pyx_v_blank_image4.shape[2];
__pyx_t_12.strides[0] = __pyx_v_blank_image4.strides[2];
    __pyx_t_12.suboffsets[0] = -1;

__pyx_t_21.data = __pyx_v_blank_image.data;
        __pyx_t_21.memview = __pyx_v_blank_image.memview;
...
__pyx_t_21.shape[0] = __pyx_v_blank_image.shape[2];
__pyx_t_21.strides[0] = __pyx_v_blank_image.strides[2];
    __pyx_t_21.suboffsets[0] = -1;

if (unlikely(__pyx_memoryview_copy_contents(__pyx_t_12, __pyx_t_21, 1, 1, 0) < 0)) __PYX_ERR(0, 16, __pyx_L1_error)
 ...
 */
  ...
  /* "MakeComposite.pyx":17
 * 			if(blank_image4[y][x][3] == 255):
 * 				blank_image[y][x] = blank_image4[y][x]
 * 	return blank_image             # <<<<<<<<<<<<<<
 */
  __PYX_INC_MEMVIEW(&__pyx_v_blank_image, 0);
  __pyx_r = __pyx_v_blank_image;
  goto __pyx_L0;
 ...
 */
  ...
  __Pyx_AddTraceback("MakeComposite.make_composite", __pyx_clineno, __pyx_lineno, __pyx_filename);
  goto __pyx_L2;
  __pyx_L0:;
...
/* Python wrapper */
static PyObject *__pyx_pw_13MakeComposite_1make_composite(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_13MakeComposite_1make_composite(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_blank_image = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_blank_image2 = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_blank_image3 = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_blank_image4 = { 0, 0, { 0 }, { 0 }, { 0 } };
  int __pyx_v_height;
  int __pyx_v_width;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_blank_image,&__pyx_n_s_blank_image2,&__pyx_n_s_blank_image3,&__pyx_n_s_blank_image4,&__pyx_n_s_height,&__pyx_n_s_width,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_blank_image)) != 0)) kw_args--;
        else goto __pyx_L5_argtuple_error;
        CYTHON_FALLTHROUGH;
        case  1:
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_blank_image2)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("make_composite", 1, 6, 6, 1); __PYX_ERR(0, 3, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_blank_image3)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("make_composite", 1, 6, 6, 2); __PYX_ERR(0, 3, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_blank_image4)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("make_composite", 1, 6, 6, 3); __PYX_ERR(0, 3, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_height)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("make_composite", 1, 6, 6, 4); __PYX_ERR(0, 3, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  5:
        if (likely((values[5] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_width)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("make_composite", 1, 6, 6, 5); __PYX_ERR(0, 3, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "make_composite") < 0)) __PYX_ERR(0, 3, __pyx_L3_error)
      }
    ...
    __pyx_v_blank_image = __Pyx_PyObject_to_MemoryviewSlice_dsdsds_unsigned_char(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_blank_image.memview)) __PYX_ERR(0, 3, __pyx_L3_error)
    __pyx_v_blank_image2 = __Pyx_PyObject_to_MemoryviewSlice_dsdsds_unsigned_char(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_blank_image2.memview)) __PYX_ERR(0, 3, __pyx_L3_error)
    __pyx_v_blank_image3 = __Pyx_PyObject_to_MemoryviewSlice_dsdsds_unsigned_char(values[2], PyBUF_WRITABLE); if (unlikely(!__pyx_v_blank_image3.memview)) __PYX_ERR(0, 3, __pyx_L3_error)
    __pyx_v_blank_image4 = __Pyx_PyObject_to_MemoryviewSlice_dsdsds_unsigned_char(values[3], PyBUF_WRITABLE); if (unlikely(!__pyx_v_blank_image4.memview)) __PYX_ERR(0, 3, __pyx_L3_error)
    __pyx_v_height = __Pyx_PyInt_As_int(values[4]); if (unlikely((__pyx_v_height == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 3, __pyx_L3_error)
    __pyx_v_width = __Pyx_PyInt_As_int(values[5]); if (unlikely((__pyx_v_width == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 3, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("make_composite", 1, 6, 6, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 3, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("MakeComposite.make_composite", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_13MakeComposite_make_composite(__pyx_self, __pyx_v_blank_image, __pyx_v_blank_image2, __pyx_v_blank_image3, __pyx_v_blank_image4, __pyx_v_height, __pyx_v_width);
...
static PyObject *__pyx_pf_13MakeComposite_make_composite(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_blank_image, __Pyx_memviewslice __pyx_v_blank_image2, __Pyx_memviewslice __pyx_v_blank_image3, __Pyx_memviewslice __pyx_v_blank_image4, int __pyx_v_height, int __pyx_v_width) {
  ...
  if (unlikely(!__pyx_v_blank_image.memview)) { __Pyx_RaiseUnboundLocalError("blank_image"); __PYX_ERR(0, 3, __pyx_L1_error) }
  if (unlikely(!__pyx_v_blank_image2.memview)) { __Pyx_RaiseUnboundLocalError("blank_image2"); __PYX_ERR(0, 3, __pyx_L1_error) }
  if (unlikely(!__pyx_v_blank_image3.memview)) { __Pyx_RaiseUnboundLocalError("blank_image3"); __PYX_ERR(0, 3, __pyx_L1_error) }
  if (unlikely(!__pyx_v_blank_image4.memview)) { __Pyx_RaiseUnboundLocalError("blank_image4"); __PYX_ERR(0, 3, __pyx_L1_error) }
  __pyx_t_1 = __pyx_f_13MakeComposite_make_composite(__pyx_v_blank_image, __pyx_v_blank_image2, __pyx_v_blank_image3, __pyx_v_blank_image4, __pyx_v_height, __pyx_v_width, 0); if (unlikely(!__pyx_t_1.memview)) __PYX_ERR(0, 3, __pyx_L1_error)
  __pyx_t_2 = __pyx_memoryview_fromslice(__pyx_t_1, 3, (PyObject *(*)(char *)) __pyx_memview_get_unsigned_char, (int (*)(char *, PyObject *)) __pyx_memview_set_unsigned_char, 0);; if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 3, __pyx_L1_error)
  ...
  __pyx_r = NULL;
  __pyx_L0:;
  __PYX_XDEC_MEMVIEW(&__pyx_v_blank_image, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_blank_image2, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_blank_image3, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_blank_image4, 1);
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "MakeComposite.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "MakeComposite._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"make_composite", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_13MakeComposite_1make_composite, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
static int __pyx_pymod_exec_MakeComposite(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_MakeComposite},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_blank_image2, __pyx_k_blank_image2, sizeof(__pyx_k_blank_image2), 0, 0, 1, 1},
  {&__pyx_n_s_blank_image3, __pyx_k_blank_image3, sizeof(__pyx_k_blank_image3), 0, 0, 1, 1},
  {&__pyx_n_s_blank_image4, __pyx_k_blank_image4, sizeof(__pyx_k_blank_image4), 0, 0, 1, 1},
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initMakeComposite(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initMakeComposite(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_MakeComposite(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_MakeComposite(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_MakeComposite(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'MakeComposite' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_MakeComposite(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("MakeComposite", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_MakeComposite) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "MakeComposite")) {
      if (unlikely(PyDict_SetItemString(modules, "MakeComposite", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init MakeComposite", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init MakeComposite");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
